...
export const tools = [
  ...
  { slug:'excel-to-pdf', category:'converters' as CategorySlug, name:'Excel to PDF', description:'Convert an Excel .xlsx first worksheet to a simple text-table PDF in your browser. Charts and layout will not match. Nothing is uploaded.', path:'/converters/excel-to-pdf/' },
  ...
  { slug:'heic-to-jpg', category:'converters' as CategorySlug, name:'HEIC to JPG', description:'Convert HEIC or HEIF photos to JPG in your browser. Native decode when available, client-side decoder fallback, quality slider. Nothing is uploaded.', path:'/converters/heic-to-jpg/' },
